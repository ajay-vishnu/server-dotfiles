...
map("n", "<leader>scj", "<C-w>j", { desc = "Move Cursor Below Pane" })
map("n", "<leader>sck", "<C-w>k", { desc = "Move Cursor Above Pane" })
map("n", "<leader>sch", "<C-w>h", { desc = "Move Cursor Left Pane" })
map("n", "<leader>scl", "<C-w>l", { desc = "Move Cursor Right Pane" })
